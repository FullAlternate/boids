...
class Vector2D():
    ...
    def __mul__(self, b):
        ...
        try:
            ...
            raise ScalarError("Right value must be castable to float, was {}".format(b))
    ...
    def __rmul__(self, b):
        try:
            ...
            raise ScalarError("Scalar must be castable to float, was {}".format(b))
    ...
    def normalized(self):
        ...
        try:
            ...
            raise VectorZeroDivisionError("Attempted to normalize a zero vector, return a unit vector at zero degrees") from e
        #    return Vector2D(1, 0)
